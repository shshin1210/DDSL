...
def configure_cam(cam, pixel_format, exposure_time_to_set_us,binning_radius, roi=None):
    ...
    node_iGain_float.SetValue(constants.GAIN)
    ...
    print('our exposure time %d ms' %(exposure_time_to_set_us/1e3))
    ...
    print('Shutter time set to %s ms max %sms...\n' % (exposure_time_to_set/1e3, cam.ExposureTime.GetMax()/1e3))
